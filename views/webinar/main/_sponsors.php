...
<table id="sponsors" class="table-striped table-bordered wide font-resp">
    ...
    <?php foreach($webinar->sponsors as $sponsor): ?>
        <tr>
            ...
            <td style="width: 5%" class="control-td pl-0 pr-0 text-center">
                ...
                Html::a(
                    ...
                    Url::toRoute(['webinar/sponsor/delete', 'webinarId' => $webinar->id, 'sponsorId' => $sponsor['id']]),
