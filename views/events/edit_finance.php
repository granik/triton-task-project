...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb d-none d-sm-none d-md-flex bg-white">
        ...
        <li class="breadcrumb-item active"><a href="#">Править финансовую информацию</a></li>
    </ol>
</nav>
...
<div class="row justify-content-center">
    ...
    echo $active_form->field($model, 'exist')
            ->radioList([0 => 'Нет', 1 => 'Да']);
    echo $active_form->field($model, 'status')
            ->radioList([0 => 'Не оплачен', 1 => 'Оплачен']);
    
    echo $active_form->field($model, 'comment')
            ->textarea();
