 ...
 */
class MossemFieldsController extends AppAdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new SearchMossemFields();
    ...
    public function actionCreate()
    {
        ...
        $modelName = "MossemFieldsForm";
        $model = new MossemFieldsForm();
...
//            $output['_csrf'] = $_POST['_csrf'];
    ...
    {
        $modelName = 'MossemFieldsForm';
        $webinarFields = new MossemFieldsForm();
