...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb d-none d-sm-none d-md-flex bg-white">
        ...
        <li class="breadcrumb-item active"><a href="/admin/city">Города</a></li>
...
<div class="row">
    ...
    <div class="city-index col-md-9">
        ...
        <p>
            <?= Html::a('Добавить', ['create'], ['class' => 'p-2 bg-primary text-white text-center float-right mb-2 col-md-2 col-xs-12']) ?>
        </p>
        <?= GridView::widget([
